...
public class MiniMapFOWRender
{
    ...
    private RawImage m_fowRenderTex = null;
    private RenderTexture m_renderTexture = null;

    public MiniMapFOWRender(Transform mapParent, Camera fowCamera, RawImage fowRenderTex)
    {
        ...
        m_renderTexture = RenderTexture.GetTemporary(fowRenderTex.mainTexture.width, fowRenderTex.mainTexture.height);
        ...
        m_fowRenderTex.texture = m_renderTexture;
    }
